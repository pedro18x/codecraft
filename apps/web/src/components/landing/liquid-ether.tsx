...
`
    ...
    // Base ShaderPass — uses _render() so subclasses can freely type their own update()
    class ShaderPass {
      props: {
        material?: {
          vertexShader: string
      ...
      // Named _render so subclasses can define their own update() signature freely
      _render() {
    ...
    class Advection extends ShaderPass {
      ...
      constructor(simProps: {
        ...
        this.uniforms = (this.props.material as NonNullable<typeof this.props.material>).uniforms
        this.init()
      }
      init() {
        super.init()
    ...
    class Simulation {
      ...
      createAllFBO() {
        ...
        for (const key in this.fbos) {
          this.fbos[key as keyof typeof this.fbos] = new THREE.WebGLRenderTarget(
            this.fboSize.x,
            this.fboSize.y,
            opts,
          )
      ...
      resize() {
        this.calcSize()
        for (const key in this.fbos) {
          this.fbos[key as keyof typeof this.fbos]!.setSize(this.fboSize.x, this.fboSize.y)
        }
      }
      update() {
